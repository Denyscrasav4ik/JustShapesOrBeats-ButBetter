...
@export var travel_x: String = "0": set = set_travel_x
func set_travel_x(val):
	travel_x = val
	update_extras()


@export var travel_y: String = "0": set = set_travel_y
func set_travel_y(val):
	travel_y = val
	update_extras()


@export var amount: int = 8: set = set_amount
func set_amount(val):
	amount = val
	update_extras()


@export var speed: float = 250: set = set_velocity
...
@export var bullets_spin: bool = true: set = set_bullets_spin
