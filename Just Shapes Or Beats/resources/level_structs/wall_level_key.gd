...
@export var size: String = "100": set = set_size
func set_size(val):
	size = val
	update_extras()


@export var direction: int = 0: set = set_direction
func set_direction(val):
	direction = val
	update_extras()


@export var direction_expr: String = "0": set = set_direction_expr
func set_direction_expr(val):
	direction_expr = val
	update_extras()


@export var peek_lenght: float = 40: set = set_peek_lenght
func set_peek_lenght(val):
	peek_lenght = val
	update_extras()


@export var show_warning: bool = true: set = set_show_warning
